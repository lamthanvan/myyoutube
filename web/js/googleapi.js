...
var ytApiUrl = 'https://www.googleapis.com/youtube/v3/videos?id=' + videoId + '&key=' + apiKey + '&fields=items&part=snippet,statistics';
var video;
...
function ytApiGetVideo(videoId) {
    ...
    ytApiUrl = 'https://www.googleapis.com/youtube/v3/videos?id=' + videoId + '&key=' + apiKey + '&fields=items&part=snippet,statistics';
    // console.log("ytAPI();" + ytApiUrl);
    video = null;
    $.ajax({
        url: ytApiUrl,
        type: 'GET',
